...
STRENGTH = {
    ...
    "cu_l_labour":   ("emerging", "Metallurgical/fabrication workers at Cable Corporation; deep-mining skills scarce after Kilembe dormancy"),
    ...
    "pc_l_labour":   ("emerging", "Chemical/process engineering skills scarce; some trained through Makerere programmes"),
