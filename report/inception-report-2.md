...
**Prepared by:** Solomon Ariho
**Date:** 27 May 2026
**Status:** Draft — submitted for TWG review and approval
...
- A complete value chain map from primary inputs to all end products
- A current state assessment (production, firms, employment, capacity utilization, trade)
- A binding constraints analysis across ten dimensions
- A market assessment (domestic, regional EAC/COMESA, export)
- A prioritized product selection (3–4 products per chain) with explicit deprioritization rationale
- A priority action matrix (quick wins, medium term, long term)
...
Compilation of production volumes, number of active firms, employment, capacity utilization, export values, and import values. Key public and private sector players identified and mapped against value chain phases.

### Part C: Binding Constraints Analysis
Analysis across ten dimensions applied consistently to each chain:

| # | Dimension |
|---|---|
| 1 | Inputs and raw materials |
| 2 | Technology and productivity |
| 3 | Energy |
| 4 | Water |
| 5 | Logistics and transport |
| 6 | Waste and effluent management |
| 7 | Finance and investment environment |
| 8 | Skills and workforce |
| 9 | Standards and quality compliance |
...
| Source | Use |
|---|---|
| Uganda Bureau of Statistics (UBOS) | Production, employment, national accounts |
| Uganda Revenue Authority (URA) trade data | Import/export volumes and values by HS code for all six chains |
| Uganda Investment Authority (UIA) | Investment project registry across all six chains |
| National Drug Authority (NDA) | Pharmaceutical manufacturer register; medicines import data |
| Cotton Development Organisation (CDO) | Cotton production, ginning, and lint export data |
| Uganda Sugar Board | Sugar production, consumption, and trade data |
| UN Comtrade / ITC Trade Map | Regional and global market sizing for all six chains |
| WHO / UNIDO pharmaceutical sector reports | Global pharmaceutical market and local manufacturing benchmarks |
| World Cement Association | Global cement market data and benchmarks |
| IFA (International Fertilizer Association) | Global fertilizer market and African consumption data |

### 4.3 Data Gaps and Mitigation

| Gap | Chain(s) affected | Mitigation |
|---|---|---|
...
| **Private sector — Sugar** | Kakira Sugar Works, Sugar Corporation of Uganda (SCOUL), Kinyara Sugar, Mayuge Sugar | Sugar & Confectionery |
...
| **Financiers** | Uganda Development Bank (UDB), EADB, commercial banks | All |
...
## 6. Prioritization Methodology and Criteria
...
Each product or sub-sector is scored 1–5 on each criterion:
...
### 6.3 Composite Score and Interpretation

Composite score = sum of (criterion score × criterion weight) across all five criteria.

Products scoring above **3.5** (out of 5) are designated priority products. Products scoring below **2.5** are explicitly deprioritized with rationale. Products scoring 2.5–3.5 are noted as conditional priorities subject to specific enabling conditions being met.
