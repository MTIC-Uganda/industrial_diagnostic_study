...
| Uganda Revenue Authority (URA) trade data | Import/export volumes and values by HS code |
| Uganda Investment Authority (UIA) | Investment project registry |
| Ministry of Energy and Mineral Development (MEMD) | Mineral reserves, mining licenses |
| UN Comtrade / ITC Trade Map | Regional and global market sizing |
| World Steel Association | Global steel production and consumption benchmarks |
| International Copper Study Group | Global copper market data |
| Kiira Motors Corporation (KMC) | Automotive production targets and steel/component requirements |

### 4.3 Data Gaps and Mitigation

| Gap | Chain affected | Mitigation |
|---|---|---|
